    ...
    function view(string $path): string
    {
        ...
        if(array_key_exists("view_path", $viewConfig)){
            ...
            if(is_dir($viewDir)){
               ...
               if(file_exists($viewFile)) return require_once $viewFile;
               throw new ConfigFileNotValid("view.php[view_path][viewFile=$viewFile][File Not Found]");
            }else{
                throw new ConfigFileNotValid("view.php[view_path][viewDir=$viewDir][View Dir not Existed]");
            }
        }else{
            throw new ConfigFileNotFound("view.php[view_path][View path key not found]");
        }
    }
